...
<body>
    <center>
        <form id='register' action="<?= $_SERVER['PHP_SELF']; ?>" method=post>
            <br>
            <input type='button' value='Server Status' onclick="window.location.href='05status.php'" />
            <input type='button' value='Add AP' onclick="window.location.href='05gold.php'" />
            <input type='button' value='Characters' onclick="window.location.href='05characters.php'" />
            <input type='button' value='Change Privilege' onclick="window.location.href='05gm.php'" />
            <input type='button' value='Change Player Name' onclick="window.location.href='05change.php'" />
            <br>
